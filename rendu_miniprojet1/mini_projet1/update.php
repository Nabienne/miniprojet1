...
<body>
  ...
  <form class="form-inline my-2 my-lg-0" method="POST" action="update.php">
    <p> Saisissez la quantité</p>
      <input name="Quantité"  class="form-control mr-sm-2" type="number" placeholder="update" aria-label="number" >
      <p>Saisissez un prix</p>
      <input name="Prix"  class="form-control mr-sm-2" type="number" placeholder="update" aria-label="number" >
      <p>Saisissez Produit</p>
      <input name="Produits"  class="form-control mr-sm-2" type="text" placeholder="update" aria-label="text" >
...
if($nom==$lists[$i]['Produits']){
 if ($lists[$i]['Quantité']!=$_POST['Quantité']){
  $lists[$i]['Quantité']=$_POST['Quantité'];
 }
 if ($lists[$i]['Prix']!=$_POST['Prix']){
  $lists[$i]['Prix']=$_POST['Prix'];
 }
}
}
